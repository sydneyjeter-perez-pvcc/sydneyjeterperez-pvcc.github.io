...
def main():
    ...
    dogs2 = dogs
    print("\nA list can be copied into another list be setting one equal to the other:")
    print("Dogs: ")
    print(dogs)
    print("Dogs2: ")
    print(dogs2)
    ...
    print("\nUse a FOR loop to give each dog in the list the same last name, using the loop:")
    for i in range(len(dogs)):
        dogs[i] = dogs[i] + " Jeter-Perez"
    print(dogs)
